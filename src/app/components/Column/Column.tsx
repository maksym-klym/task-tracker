export function Column() {
    return (
        <div className="flex flex-col bg-gray-800 p-4 rounded-2xl shadow-md w-80 max-h-[95vh] pr-1">
        <h2 className="text-xl font-bold text-white mb-4 text-center">Column title</h2>
